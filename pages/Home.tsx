      ...
      <section className="relative min-h-screen flex items-center overflow-hidden bg-neutral">
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10 py-32 md:py-0 -mt-8 md:-mt-16">
          <div className="max-w-4xl">
            <h1 className="text-8xl md:text-8xl font-bold mb-10 leading-[0.95] tracking-tighter text-white">
              Hon. Nabeela <br className="hidden lg:block" />
              <span className="text-primary italic font-serif relative inline-block">
                Farida
                <svg
                  className="absolute -bottom-4 left-0 w-full h-3 text-primary/40"
                  viewBox="0 0 100 10"
            ...
            <p className="text-xl md:text-2xl mb-14 text-white/80 leading-relaxed max-w-2xl animate-in slide-up delay-100 italic font-light border-l-2 border-primary/40 pl-10">
              ...
              Leone. Dedicated to fostering national unity and sustainable
              growth.
            </p>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-24 max-w-2xl mx-auto animate-in slide-up">
            ...
            <p className="text-lg text-base-content/60 leading-relaxed font-light">
              Strategic leadership that bridges diplomacy, culture, and
              humanitarian action for a better Sierra Leone.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-10">
            <div className="premium-card p-10 group bg-white/50 backdrop-blur-sm">
              ...
              <h3 className="text-2xl font-bold mb-4 serif tracking-tight">
                Global Diplomacy
              </h3>
              <p className="text-base-content/60 leading-relaxed mb-8">
                Strengthening international partnerships and elevating Sierra
                Leone's voice across the United Nations and African Union.
              </p>
              <Link
                to="/impact"
                className="text-sm font-bold uppercase tracking-widest text-primary hover:underline flex items-center gap-2"
              >
                Learn More{" "}
                <svg
                  className="w-4 h-4"
            ...
            <div className="premium-card p-10 group bg-white/50 backdrop-blur-sm xl:scale-110 xl:z-10 xl:shadow-2xl xl:border-primary/10">
              ...
              <p className="text-base-content/60 leading-relaxed mb-8">
                Revitalizing national heritage and tourism through the "Tourism
                for All" campaign, driving sustainable community growth.
              </p>
              <Link
                to="/tourism"
                className="text-sm font-bold uppercase tracking-widest text-secondary hover:underline flex items-center gap-2"
              >
                Discover More{" "}
                <svg
                  className="w-4 h-4"
            ...
            <div className="premium-card p-10 group bg-white/50 backdrop-blur-sm">
              ...
              <p className="text-base-content/60 leading-relaxed mb-8">
                Empowering vulnerable communities through educational support,
                unity programs, and compassionate humanitarian aid.
              </p>
              <Link
                to="/foundation"
                className="text-sm font-bold uppercase tracking-widest text-accent hover:underline flex items-center gap-2"
              >
                Support Foundation{" "}
                <svg
                  className="w-4 h-4"
      ...
      <section className="relative section-padding overflow-hidden bg-primary text-primary-content text-center">
        ...
        <div className="container mx-auto relative z-10">
          <div className="max-w-4xl mx-auto">
            <svg
              className="h-16 w-16 mx-auto mb-10 opacity-20"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
